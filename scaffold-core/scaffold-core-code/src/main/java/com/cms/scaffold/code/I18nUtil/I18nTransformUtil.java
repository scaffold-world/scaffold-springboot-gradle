package com.cms.scaffold.code.I18nUtil;
...
public class I18nTransformUtil {
    ...
    public static <T> T transForm(T object, String fieldName) {
        Object i18nId = Reflections.invokeGetter(object, "i18nNid");
        MessageSource messageSource = SpringContextHolder.getBean("messageSource");
        if(null != messageSource){
            if (StringUtil.isNotBlank(String.valueOf(i18nId))) {
                String name = null;
                try {
                    ...
                    if (StringUtil.isNotBlank(name)) {
                        if(name.equals(i18nId)){
                            ...
                            Reflections.invokeSetter(object, fieldName, name);
                        }
                    }else{
