...
public class AddressUtils {
    ...
    public static Map<String, String> getAddresses(String ip) {
     ...
     */
    public static Map<String, String> getAddresses(String ip, String encodingString) {
        try {
            ...
            if (returnStr != null) {
                ...
                JSONObject result = JSON.parseObject(returnStr);
                if (result.getInteger("code") == 0) {
                    ...
                    if (data != null) {
                        ...
                        map.put("province", data.getString("region"));
