...
public class CmdUtil {
    ...
    public static void main(String[] args) {
        ...
        String file = "/Users/张嘉恒/Desktop/user.xls";

        String shellMysql = "mysql -h localhost -u root -proot -e 'use p2p;select * from rd_user' >/Users/张嘉恒/Desktop/user.xls;";

        String convertFile = "iconv -f utf-8 -t GBK /Users/张嘉恒/Desktop/user.xls > /Users/张嘉恒/Desktop/user1.xls;";
