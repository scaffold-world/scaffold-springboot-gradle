...
import com.cms.scaffold.route.operate.response.sys.UploadResponse;
...
/** @Description 文件上传 @Date 2018/11/1 19:49 */
@Controller
@RequestMapping("/sys/upload/")
@Api(tags = "SysUploadController", description = "资源上传管理页面")
public class SysUploadController extends BaseController {
  ...
  public String uploadFile(MultipartFile file) throws IOException {
    ...
    out.close();
    // 删除处理文件上传时生成的临时文件
    AliyunOSSClientUtil.uploadObject2OSS(
        out.toByteArray(), fileName, AliyunOSSClientUtil.getBucketName(), OSS_FOLDER);
