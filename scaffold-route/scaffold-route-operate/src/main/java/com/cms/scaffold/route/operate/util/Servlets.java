...
public class Servlets {
    ...
    private final static String[] staticFiles = new String[]{".css",".js",".png",".jpg",".gif",".jpeg",".bmp",".ico",".swf",".psd",".htc",
            ".crx",".xpi",".exe",".ipa",".apk"};
    ...
    public static boolean isStaticFile(String uri){
        ...
        if (StringUtil.endsWithAny(uri, staticFiles)
                && !StringUtil.endsWithAny(uri, ".ftl") && !StringUtil.endsWithAny(uri, ".java")){
            return true;
        }
        return false;
    }
