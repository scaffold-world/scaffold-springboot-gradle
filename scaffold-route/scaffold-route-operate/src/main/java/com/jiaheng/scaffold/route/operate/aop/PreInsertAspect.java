...
public class PreInsertAspect {
    ...
    @Before("execution(* com.jiaheng.scaffold.*.*.dao.*.insert*(..)) || execution( * com.jiaheng.scaffold.sys.BaseMapper.insert*(..)) " +
            "|| execution( * com.jiaheng.scaffold.core.baseService.BaseMapper.insert*(..))")
