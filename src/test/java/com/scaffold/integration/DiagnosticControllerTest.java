...
class DiagnosticControllerTest extends IntegrationTestBase {

    @Autowired
    private MockMvc mvc;

    @Test
    void shouldReturn200ForDiagnostic() throws Exception {
    ...
    @Test
    void shouldReturn200ForHeartbeat() throws Exception {
        this.mvc.perform(get("/diagnostic/status/heartbeat")).andExpect(status().isOk());
    }

    @Test
    void shouldReturn200ForDiagnosis() throws Exception {
    ...
    @Test
    void shouldReturn200ForNagiosIfDatabaseIsHealthy() throws Exception {
